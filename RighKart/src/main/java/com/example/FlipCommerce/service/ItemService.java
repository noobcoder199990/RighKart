...
public class ItemService {
    ...
    public Item removeItem(RemoveItemFromCartDto removeItemFromCartDto) throws Exception {
        Optional<Item> itemopt= itemRepository.findById(removeItemFromCartDto.getItemId());
        if(itemopt.isEmpty())
           throw  new Exception("Item not found in given email");
